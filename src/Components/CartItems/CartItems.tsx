...
function CartItems() {
  ...
  }, [initialItems, loading, setCartItems]);

  return (
    <main className="max-w-4xl mx-auto p-6 bg-white shadow-xl mt-8">
      <h1 className="text-3xl font-light text-center mb-10 tracking-widest text-gray-800">
        YOUR BAG
      </h1>
      ...
      <footer className="flex flex-col items-center space-y-6">
        ...
        <button onClick={() => setCartItems([])} className="px-6 py-2 text-sm text-purple-700 border border-purple-400 rounded-md hover:bg-purple-50 transition duration-150">
          Clear Cart
        </button>
      </footer>
    </main>
